...
import com.launch.starter.tasks.delay.DelayInitTaskA;
import com.launch.starter.tasks.delay.DelayInitTaskB;
        ...
        RetrofitNewsUtils.getApiService().getNBANews("banner", mStringIds)
                .enqueue(new Callback<ResponseBody>() {
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        try {
                            LogUtils.i("battery " + "getNews onResponse：" + response);
                            ...
                            while (keys.hasNext()) {
                                ...
                                mItems.add(newsItem);
                                LogUtils.i("battery " + "getNews mItems：" + mItems.size());
                            }
                    ...
                    public void onFailure(Call<ResponseBody> call, Throwable t) {
                        LogUtils.i("battery " + "getNews onFailure：" + t.getMessage().toString());
                    }
                });
    }
