...
public class TaskDispatcherTest {
    ...
    private AsyncInitDispatcher taskDispatcher;
    ...
    public void setUp() {
        ...
        AsyncInitDispatcher.init(RuntimeEnvironment.application);
        taskDispatcher = AsyncInitDispatcher.createInstance();
    }
